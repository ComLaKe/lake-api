...
public class MethodSecurityConfiguration extends GlobalMethodSecurityConfiguration {
	...
	/**
	 * Define JDBC ACL service These 2 simple SQL queries are MySQL specific, so if
	 * need supporting multiple databases, you might want to put these in
	...
	// this allows us to actually customize the decision to grant a permission (or
	// not) based on the ACL entry
	@Bean
